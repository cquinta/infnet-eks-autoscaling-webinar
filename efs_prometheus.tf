# =============================================================================
# EFS PARA ARMAZENAMENTO PERSISTENTE DO PROMETHEUS
# =============================================================================
# Cria sistema de arquivos EFS para dados de métricas do Prometheus
...
# StorageClass Kubernetes para usar o EFS do Prometheus
